...
When the application start, all PowerShell commands are analyze by reflexion and a OpenAPI specficiation file are generated.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM5NTkyMzc0N119
-->