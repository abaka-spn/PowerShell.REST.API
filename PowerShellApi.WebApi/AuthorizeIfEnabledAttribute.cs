	...
	public class AuthorizeIfEnabledAttribute : AuthorizeAttribute
	{
		...
		public override void OnAuthorization(HttpActionContext actionContext)
		{
            ...
            if (!Enum.TryParse(request.Method.Method, true, out RestMethod requestMethod))
            {
                ...
                PowerShellRestApiEvents.Raise.VerboseMessaging(String.Format("Http method ({0}) not supported", request.Method.Method));
            ...
            PSCommand psCommand = Routes.Instance[requestMethod][route];
            */
            PSCommand psCommand = Routes.Get(request.RequestUri, request.Method.Method);
