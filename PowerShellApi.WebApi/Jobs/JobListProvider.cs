...
namespace PowerShellRestApi.Jobs
{
	/// <summary>	A job list provider. </summary>
	/// <remarks>	Anthony, 6/1/2015. </remarks>
	/// <seealso cref="T:PowerShellRestApi.Jobs.IJobListProvider"/>
		...
		: IJobListProvider
	{
		...
		/// <summary> Initializes a new instance of the PowerShellRestApi.Jobs.JobListProvider
		/// 	class. </summary>
		/// <remarks>	Anthony, 6/1/2015. </remarks>
		...
		/// <seealso cref="M:PowerShellRestApi.Jobs.IJobListProvider.AddRequestedJob(Guid,string)"/>
		...
		/// <seealso cref="M:PowerShellRestApi.Jobs.IJobListProvider.CompleteJob(Guid,bool,string)"/>
		...
		/// <seealso cref="M:PowerShellRestApi.Jobs.IJobListProvider.DidJobSucceed(Guid)"/>
		...
		/// <seealso cref="M:PowerShellRestApi.Jobs.IJobListProvider.GetRunningJobs()"/>
