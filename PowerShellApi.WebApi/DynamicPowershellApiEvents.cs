namespace PowerShellRestApi
{
	...
	public sealed class PowerShellRestApiEvents : EventSource
	{
		/// <summary>
		/// The singleton instance.
		/// </summary>
		private static readonly Lazy<PowerShellRestApiEvents> Instance =
			new Lazy<PowerShellRestApiEvents>(() => new PowerShellRestApiEvents());

		/// <summary>
		/// The Dynamic PowerShell API event source name.
		/// </summary>
		public const string EventSourceName = "DDCloud-PowerShellRestApi";

		/// <summary>
		///	Singleton instance of the event-source that can be used to raise events.
		/// </summary>
		public static PowerShellRestApiEvents Raise
		{
			get
			{
		...
		/// <summary>
		/// Prevents a default instance of the <see cref="PowerShellRestApiEvents"/> class from being created.
		/// </summary>
		private PowerShellRestApiEvents()
#if DEBUG
