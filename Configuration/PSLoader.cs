    ...
    class PSLoader
    {
        ...
        public PSCommand GetPSCommand()
        {
            ...
            foreach (dynamic paramHelp in psHelpParamters)
            {
                ...
                if (paramName.Equals(_cmdConfig.ParameterForUser, StringComparison.InvariantCultureIgnoreCase) &&
                ...
                else if (paramName.Equals(_cmdConfig.ParameterForRoles, StringComparison.InvariantCultureIgnoreCase) &&
                    paramType == typeof(String[]))
                {
                ...
                else if (paramName.Equals(_cmdConfig.ParameterForClaims, StringComparison.InvariantCultureIgnoreCase) &&
                ...
                else if (string.IsNullOrWhiteSpace(_cmdConfig.ParameterForClaims) &&
                    paramType == typeof(Claim[]))
                {
                    psCmd.ParameterForClaims = paramName;
                    psParam.Hidden = true;
